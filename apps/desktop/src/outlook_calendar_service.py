...
"""
Outlook Calendar Service for HiDock Light.
...
class OutlookCalendarService:
    ...
    def find_meeting_for_audio_file(
        self, file_datetime: datetime, duration_seconds: int = None
    ) -> Optional[MeetingMetadata]:
        """
        ...
        for meeting in meetings:
            ...
            elif meeting.start_time <= file_datetime <= meeting.start_time + timedelta(minutes=30):
