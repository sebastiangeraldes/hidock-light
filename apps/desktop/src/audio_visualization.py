"""
Audio Visualization Module for HiDock Light
...
class AudioVisualizationWidget(ctk.CTkFrame):
    ...
    def _load_theme_icons(self):
        ...
        try:
            ...
            # Get the root directory (parent of src/) and construct icon paths
            script_dir = os.path.dirname(os.path.abspath(__file__))
            root_dir = os.path.dirname(script_dir)  # Go up from src/ to root
            icons_dir = os.path.join(root_dir, "icons", "white", "16")
    ...
    def _create_speed_controls(self):
        ...
        try:
            ...
            # Preset speed buttons - TEMPORARILY HIDDEN (not working properly)
            # TODO: Fix speed preset functionality before re-enabling
