...
class HiDockJensen:
    ...
    def _calculate_file_duration(self, file_size_bytes, file_version):
        ...
        if file_version == 1:
            ...
            # P1 firmware 1.4.5 stores v5 recordings as 96 kbps MP3
            # (12,000 bytes/second). The legacy 4x correction is not valid here.
            return file_size_bytes / SAMPLE_RATE_12K
        else:
