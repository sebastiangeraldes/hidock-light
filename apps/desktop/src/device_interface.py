"""
Unified device interface abstraction for HiDock Light.

This module provides a common interface for device operations, enabling
consistent device management, model detection, capability reporting,
storage monitoring, and health diagnostics.

HiDock Light implements this interface for direct USB communication with
HiDock devices while keeping transport details behind one contract.
"""
