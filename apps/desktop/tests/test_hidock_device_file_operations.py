...
class TestHiDockJensenFileListOperations:
    ...
    def test_calculate_file_duration_version_5(self, jensen_device):
        """Version 5 P1 files are 96 kbps MP3 and must not receive the legacy 4x correction."""
        duration = jensen_device._calculate_file_duration(8_516_460, 5)
        assert duration == 8_516_460 / 12_000
