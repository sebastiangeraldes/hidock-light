...
class TestAdvancedAudioProcessing:
    ...
    def mock_audio_data(self):
        ...
        return {"data": audio_data, "sample_rate": sample_rate, "duration": duration, "channels": 1, "bit_depth": 16}
    ...
    def mock_audio_file(self, mock_audio_data):
        ...
        return {
            ...
            "format": "WAV",
            "metadata": {"title": "Test Audio", "artist": "Test Artist", "duration": mock_audio_data["duration"]},
        }
...
class TestAudioFileHandling:
    ...
    def test_file_size_formatting(self):
        ...
        test_cases = [(512, "512 B"), (1536, "1.5 KB"), (1572864, "1.5 MB"), (1610612736, "1.5 GB")]
    ...
    def test_duration_formatting(self):
        ...
        test_cases = [(0, "0:00"), (30, "0:30"), (75, "1:15"), (3661, "1:01:01"), (-5, "0:00")]
